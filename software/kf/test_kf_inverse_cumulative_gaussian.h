/**
 * @file test_kf_inverse_cumulative_gaussian.c
 * @brief Implementation of the inverse cumulative Gaussian function.
 *
 * Algorithm was created Peter John Acklam from the University of Oslo, Norway (https://web.archive.org/web/20151030215612/http://home.online.no/~pjacklam/notes/invnorm/).
 * Translated to C by Dr. V. Natarajan at the Society for Electronic Transactions and Security (SETS), Chennai (Madras), India (https://setsindia.in/dr-v-natarajan/).
 *
 * License, as paraphrased from the source website (valid only for this file):
 *
 * Use [this algorithm] as you wish, for whatever purpose. [Please] show common courtesy and give credit where credit is due.
 */
