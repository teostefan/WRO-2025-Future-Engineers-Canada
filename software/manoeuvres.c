...
int go(int speed, float neutralHeading, int hugMux, int hugTarget, int stopMux, int stopTarget, int safetyMux, int safetyTarget, int way) {
    int count = 0;
...
int in_out() {
    if (direction == CLOCKWISE) {
        ...
        go(SLOW_SPEED, ((270 + direction * ((stretch * 90))) % 360), -1, -1, FRONT_MUX, 300, LEFT_MUX, 0, 0);
        ...
        if (stretch == 0) {
            go(SLOW_SPEED, ((90 + direction * ((stretch * 90))) % 360), -1, -1, REAR_MUX, 400, LEFT_MUX, 0, 1);
        } else {
            go(SLOW_SPEED, ((90 + direction * ((stretch * 90))) % 360), -1, -1, FRONT_MUX, 300, LEFT_MUX, 0, 0);
        }
...
int in_out_turn() {
    if (direction == CLOCKWISE) {
        if (stretch == 0) {
            go(SLOW_SPEED, ((0 + direction * ((stretch * 90))) % 360), -1, -1, FRONT_MUX, 600, LEFT_MUX, 0, 0);
        } else {
...
int out_in_turn() {
    if (direction == CLOCKWISE) {
        ...
        turn(45, ((180 + direction * ((stretch * 90))) % 360));

        usleep(500000);

        go(SLOW_SPEED, ((125 + direction * ((stretch * 90))) % 360), -1, -1, FRONT_MUX, 325, LEFT_MUX, 0, 0);

        turn(45, ((90 + direction * ((stretch * 90))) % 360));

        go(MEDIUM_SPEED, ((90 + direction * ((stretch * 90))) % 360), -1, -1, REAR_MUX, 300, LEFT_MUX, 0, 1);
        ...
        go(SLOW_SPEED, ((235 + direction * ((stretch * 90))) % 360), -1, -1, FRONT_MUX, 325, LEFT_MUX, 0, 0);
...
int in_blind_turn() {
    if (direction == CLOCKWISE) {
        ...
        turn(45, ((130 + direction * ((stretch * 90))) % 360));
        ...
        go(SLOW_SPEED, ((90 + direction * ((stretch * 90))) % 360), -1, -1, FRONT_MUX, 200, RIGHT_MUX, 0, 0);

        turn(-45, ((0 + direction * ((stretch * 90))) % 360));

        go(SLOW_SPEED, ((0 + direction * ((stretch * 90))) % 360), -1, -1, FRONT_MUX, 200, RIGHT_MUX, 0, 0);

        turn(-45, ((230 + direction * ((stretch * 90))) % 360));
...
int pull_out() {
    if (direction == CLOCKWISE) {
        ...
        if (firstObstacle != GREEN_GREEN && firstObstacle != GREEN_RED) {
            ...
            go(SLOW_SPEED, ((0 + direction * ((stretch * 90))) % 360), RIGHT_MUX, 200, FRONT_MUX, 300, LEFT_MUX, 0, 0);
...
int parallel_park() {
    if (direction == CLOCKWISE) {
        ...
        go(SLOW_SPEED, ((90 + direction * ((stretch * 90))) % 360), -1, -1, LEFT_MUX, SEE_WALL_DISTANCE, LEFT_MUX, 0, 0);
        ...
        go(SLOW_SPEED, ((270 + direction * ((stretch * 90))) % 360), -1, -1, RIGHT_MUX, SEE_WALL_DISTANCE, RIGHT_MUX, 0, 0);
...
int open_challenge() {
    ...
    for (int i = 1; i < 12; i++) {
        ...
        go(110, ((0 + direction * ((i * 90))) % 360), mux, 200, mux, 1200, not_mux, 150, 1);
    }
